...
public abstract class SimpleTermImpl extends SourceTermImpl implements SimpleTerm {
    ...
    protected EClass eStaticClass() {
        return TefkatPackage.eINSTANCE.getSimpleTerm();
    }
    ...
    public void setTRuleTgt(TRule newTRuleTgt) {
        if (newTRuleTgt != eContainer || (eContainerFeatureID != TefkatPackage.SIMPLE_TERM__TRULE_TGT && newTRuleTgt != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, TefkatPackage.SIMPLE_TERM__TRULE_TGT, newTRuleTgt, newTRuleTgt));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case TefkatPackage.SIMPLE_TERM__PATTERN_DEFN:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, TefkatPackage.SIMPLE_TERM__PATTERN_DEFN, msgs);
                case TefkatPackage.SIMPLE_TERM__QUERY:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, TefkatPackage.SIMPLE_TERM__QUERY, msgs);
                case TefkatPackage.SIMPLE_TERM__COMPOUND_TERM:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, TefkatPackage.SIMPLE_TERM__COMPOUND_TERM, msgs);
                case TefkatPackage.SIMPLE_TERM__TRULE_SRC:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, TefkatPackage.SIMPLE_TERM__TRULE_SRC, msgs);
                case TefkatPackage.SIMPLE_TERM__TRULE_TGT:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, TefkatPackage.SIMPLE_TERM__TRULE_TGT, msgs);
                default:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case TefkatPackage.SIMPLE_TERM__PATTERN_DEFN:
                    return eBasicSetContainer(null, TefkatPackage.SIMPLE_TERM__PATTERN_DEFN, msgs);
                case TefkatPackage.SIMPLE_TERM__QUERY:
                    return eBasicSetContainer(null, TefkatPackage.SIMPLE_TERM__QUERY, msgs);
                case TefkatPackage.SIMPLE_TERM__COMPOUND_TERM:
                    return eBasicSetContainer(null, TefkatPackage.SIMPLE_TERM__COMPOUND_TERM, msgs);
                case TefkatPackage.SIMPLE_TERM__TRULE_SRC:
                    return eBasicSetContainer(null, TefkatPackage.SIMPLE_TERM__TRULE_SRC, msgs);
                case TefkatPackage.SIMPLE_TERM__TRULE_TGT:
                    return eBasicSetContainer(null, TefkatPackage.SIMPLE_TERM__TRULE_TGT, msgs);
                default:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            ...
            case TefkatPackage.SIMPLE_TERM__CONTEXT:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass) {
        if (baseClass == TargetTerm.class) {
            switch (derivedFeatureID) {
                case TefkatPackage.SIMPLE_TERM__TRULE_TGT: return TefkatPackage.TARGET_TERM__TRULE_TGT;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
        if (baseClass == TargetTerm.class) {
            switch (baseFeatureID) {
                case TefkatPackage.TARGET_TERM__TRULE_TGT: return TefkatPackage.SIMPLE_TERM__TRULE_TGT;
                default: return -1;
            }
        }
