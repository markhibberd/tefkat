 ...
 * @since 3.2
 */
public class TefkatObjectModelPlaceHolder {
     ...
     */
    public TefkatObjectModelPlaceHolder(String aName, String aValue, IFile aFile) {
        name = aName;
        value = aValue;
        container = aFile;
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof TefkatObjectModelPlaceHolder
                && ((TefkatObjectModelPlaceHolder) obj).getName().equals(name);
    }
