...
public TefkatLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("LINKS", this), new Integer(74));
	literals.put(new ANTLRHashString("IF", this), new Integer(68));
	literals.put(new ANTLRHashString("FORALL", this), new Integer(55));
	literals.put(new ANTLRHashString("QUERY", this), new Integer(47));
	literals.put(new ANTLRHashString("FROM", this), new Integer(78));
	literals.put(new ANTLRHashString("OVERRIDES", this), new Integer(62));
	literals.put(new ANTLRHashString("LINKING", this), new Integer(79));
	literals.put(new ANTLRHashString("false", this), new Integer(82));
	literals.put(new ANTLRHashString("true", this), new Integer(81));
	literals.put(new ANTLRHashString("PATTERN", this), new Integer(54));
	literals.put(new ANTLRHashString("NOT", this), new Integer(73));
	literals.put(new ANTLRHashString("ELSE", this), new Integer(72));
	literals.put(new ANTLRHashString("RULE", this), new Integer(59));
	literals.put(new ANTLRHashString("WITH", this), new Integer(80));
	literals.put(new ANTLRHashString("DYNAMIC", this), new Integer(65));
	literals.put(new ANTLRHashString("THEN", this), new Integer(70));
	literals.put(new ANTLRHashString("MAP", this), new Integer(51));
	literals.put(new ANTLRHashString("IMPORT", this), new Integer(52));
	literals.put(new ANTLRHashString("TRANSFORMATION", this), new Integer(48));
	literals.put(new ANTLRHashString("UNDEF", this), new Integer(75));
	literals.put(new ANTLRHashString("CLASS", this), new Integer(50));
	literals.put(new ANTLRHashString("TEMPLATE", this), new Integer(57));
	literals.put(new ANTLRHashString("AND", this), new Integer(66));
	literals.put(new ANTLRHashString("ELSEIF", this), new Integer(71));
	literals.put(new ANTLRHashString("IN", this), new Integer(77));
	literals.put(new ANTLRHashString("WHERE", this), new Integer(56));
	literals.put(new ANTLRHashString("SET", this), new Integer(61));
	literals.put(new ANTLRHashString("MAKE", this), new Integer(60));
	literals.put(new ANTLRHashString("BEFORE", this), new Integer(76));
	literals.put(new ANTLRHashString("SUPERSEDES", this), new Integer(63));
	literals.put(new ANTLRHashString("EXTENDS", this), new Integer(49));
	literals.put(new ANTLRHashString("ABSTRACT", this), new Integer(58));
	literals.put(new ANTLRHashString("EXACT", this), new Integer(64));
	literals.put(new ANTLRHashString("NAMESPACE", this), new Integer(53));
	literals.put(new ANTLRHashString("ENDIF", this), new Integer(69));
...
tryAgain:
	...
	protected final String  mHEX_FOUR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		String s = null;
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = HEX_FOUR;
		int _saveIndex;
		...
		mHEX(false);
		if ( inputState.guessing==0 ) {
			s = new String(text.getBuffer(),_begin,text.length()-_begin);
		}
		if ( _createToken && _token==null && _ttype!=Token.SKIP ) {
			_token = makeToken(_ttype);
			_token.setText(new String(text.getBuffer(), _begin, text.length()-_begin));
...
inputState.guessing--;
	...
	protected final void mESCAPE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case 'u':
		{
			...
			h1=mHEX_FOUR(false);
			if ( inputState.guessing==0 ) {
				text.setLength(_begin); text.append(unicode(h1));
			}
			break;
		}
		default:
