 ...
 *
 *  History:  Created on 23/10/2003 by agerber
 *
 * @author agerber
...
import com.dstc.tefkat.model.Injection;
...
import com.dstc.tefkat.model.util.TefkatSwitch;
...
//            System.out.println(level + ": " + scope);
    ...
    static class Stratifier extends TefkatSwitch {
        ...
        /* (non-Javadoc)
         * @see com.dstc.tefkat.model.util.TefkatSwitch#doSwitch(org.eclipse.emf.ecore.EObject)
         */
...
//        }
        ...
        /* (non-Javadoc)
         * @see com.dstc.tefkat.model.util.TefkatSwitch#caseNotTerm(com.dstc.tefkat.model.NotTerm)
         */
        ...
        /* (non-Javadoc)
         * @see com.dstc.tefkat.model.util.TefkatSwitch#caseIfTerm(com.dstc.tefkat.model.IfTerm)
         */
         ...
         * 
         * @see com.dstc.tefkat.model.util.TefkatSwitch#caseTrackingUse(com.dstc.tefkat.model.TrackingUse)
         */
        ...
        /* (non-Javadoc)
         * @see com.dstc.tefkat.model.util.TefkatSwitch#casePatternUse(com.dstc.tefkat.model.PatternUse)
         */
        ...
        /* (non-Javadoc)
         * @see com.dstc.tefkat.model.util.TefkatSwitch#caseCompoundTerm(com.dstc.tefkat.model.CompoundTerm)
         */
...
//                        } else
    ...
    static class TestBulidMaps {
        ...
        private static MofInstance mi(AbstractVar v, String type) {
            ...
            com.dstc.tefkat.model.StringConstant t = TefkatFactory.eINSTANCE
                    .createStringConstant();
            t.setRepresentation(type);
            com.dstc.tefkat.model.VarUse vu = TefkatFactory.eINSTANCE
                    .createVarUse();
            vu.setVar(v);
            mi.setTypeName(t);
            mi.setInstance(vu);
...
//            newResources.removeAll(result); // ignore things we've already seen
    ...
    private static class TestSort {
        public static void main(String[] args) {
            ...
            Map instanceOrderings = new HashMap();
