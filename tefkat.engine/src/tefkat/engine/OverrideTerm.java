...
public class OverrideTerm implements Term {
    ...
    /* (non-Javadoc)
     * @see tefkat.model.Term#setPatternDefn(tefkat.model.PatternDefn)
     */
    ...
    /* (non-Javadoc)
     * @see tefkat.model.Term#setQuery(tefkat.model.Query)
     */
    ...
    /* (non-Javadoc)
     * @see tefkat.model.Term#setCompoundTerm(tefkat.model.CompoundTerm)
     */
    ...
    /* (non-Javadoc)
     * @see tefkat.model.Term#setContext(tefkat.model.ExtentVar)
     */
    ...
    /* (non-Javadoc)
     * @see tefkat.model.Term#getExtent()
     */
