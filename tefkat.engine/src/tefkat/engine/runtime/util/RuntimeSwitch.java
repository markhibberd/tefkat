...
public class RuntimeSwitch {
    ...
    protected Object doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case RuntimePackage.REFERENCE_EXTENT: {
            ...
            case RuntimePackage.TRANSFORMATION: {
            ...
            case RuntimePackage.NAMESPACE_DECLARATION: {
            ...
            case RuntimePackage.PATTERN_DEFN: {
            ...
            case RuntimePackage.TERM: {
                Term term = (Term)theEObject;
                Object result = caseTerm(term);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RuntimePackage.SOURCE_TERM: {
            ...
            case RuntimePackage.TARGET_TERM: {
            ...
            case RuntimePackage.COMPOUND_TERM: {
            ...
            case RuntimePackage.SIMPLE_TERM: {
            ...
            case RuntimePackage.EXPRESSION: {
                Expression expression = (Expression)theEObject;
                Object result = caseExpression(expression);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RuntimePackage.INSTANCE_REF: {
            ...
            case RuntimePackage.TRACKING_USE: {
            ...
            case RuntimePackage.MOF_INSTANCE: {
            ...
            case RuntimePackage.COMPOUND_EXPR: {
            ...
            case RuntimePackage.SIMPLE_EXPR: {
            ...
            case RuntimePackage.COLLECTION_EXPR: {
            ...
            case RuntimePackage.FUNCTION_EXPR: {
            ...
            case RuntimePackage.FEATURE_EXPR: {
            ...
            case RuntimePackage.STRING_CONSTANT: {
            ...
            case RuntimePackage.INT_CONSTANT: {
            ...
            case RuntimePackage.REAL_CONSTANT: {
            ...
            case RuntimePackage.BOOLEAN_CONSTANT: {
            ...
            case RuntimePackage.ENUM_CONSTANT: {
