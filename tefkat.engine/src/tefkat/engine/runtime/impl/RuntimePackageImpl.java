...
import tefkat.engine.runtime.MofTerm;
...
public class RuntimePackageImpl extends EPackageImpl implements RuntimePackage {
     ...
     * @generated
     */
    private EDataType resolutionExceptionEDataType = null;
     ...
     * @generated
     */
    private EDataType notGroundExceptionEDataType = null;
     ...
     * @see tefkat.engine.runtime.RuntimePackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public static RuntimePackage init() {
        ...
        RuntimePackageImpl theRuntimePackage = (RuntimePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof RuntimePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new RuntimePackageImpl());
     ...
     * @generated
     */
    public EDataType getResolutionException() {
        return resolutionExceptionEDataType;
    }
     ...
     * @generated
     */
    public EDataType getNotGroundException() {
        return notGroundExceptionEDataType;
    }
    ...
    public void createPackageContents() {
        ...
        resolutionExceptionEDataType = createEDataType(RESOLUTION_EXCEPTION);
        notGroundExceptionEDataType = createEDataType(NOT_GROUND_EXCEPTION);
    }
    ...
    public void initializePackageContents() {
        ...
        addEOperation(tRuleEClass, this.getCollection(), "getGoal", 0, 1);
        ...
        op = addEOperation(sourceTermEClass, null, "match");
        addEParameter(op, this.getContext(), "context", 0, 1);
        addEException(op, this.getResolutionException());
        addEException(op, this.getNotGroundException());
        ...
        op = addEOperation(targetTermEClass, null, "ensure");
        addEParameter(op, this.getContext(), "context", 0, 1);
        addEException(op, this.getResolutionException());
        addEException(op, this.getNotGroundException());
        ...
        op = addEOperation(expressionEClass, this.getList(), "eval", 0, 1);
        addEParameter(op, this.getContext(), "context", 0, 1);
        addEException(op, this.getResolutionException());
        addEException(op, this.getNotGroundException());
        ...
        op = addEOperation(expressionEClass, this.getList(), "eval", 0, 1);
        addEParameter(op, this.getContext(), "context", 0, 1);
        addEParameter(op, this.getBinding(), "binding", 0, 1);
        addEException(op, this.getResolutionException());
        addEException(op, this.getNotGroundException());
        ...
        initEDataType(resolutionExceptionEDataType, ResolutionException.class, "ResolutionException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(notGroundExceptionEDataType, NotGroundException.class, "NotGroundException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
