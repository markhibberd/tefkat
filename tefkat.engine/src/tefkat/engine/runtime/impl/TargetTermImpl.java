 ...
 * <ul>
 *   <li>{@link tefkat.engine.runtime.impl.TargetTermImpl#getTRuleTgt <em>TRule Tgt</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TargetTermImpl extends TermImpl implements TargetTerm {
    ...
    protected EClass eStaticClass() {
        return RuntimePackage.Literals.TARGET_TERM;
    }
    ...
    public TRule getTRuleTgt() {
        if (eContainerFeatureID != RuntimePackage.TARGET_TERM__TRULE_TGT) return null;
    ...
    public NotificationChain basicSetTRuleTgt(TRule newTRuleTgt, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newTRuleTgt, RuntimePackage.TARGET_TERM__TRULE_TGT, msgs);
        return msgs;
    }
    ...
    public void setTRuleTgt(TRule newTRuleTgt) {
        if (newTRuleTgt != eInternalContainer() || (eContainerFeatureID != RuntimePackage.TARGET_TERM__TRULE_TGT && newTRuleTgt != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, RuntimePackage.TARGET_TERM__TRULE_TGT, newTRuleTgt, newTRuleTgt));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RuntimePackage.TARGET_TERM__TRULE_TGT:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
