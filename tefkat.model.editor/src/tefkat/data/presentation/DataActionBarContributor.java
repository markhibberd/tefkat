...
public class DataActionBarContributor
	...
	protected IAction showPropertiesViewAction =
        new Action(TefkatDataEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
            public void run() {
                try {
	...
	protected IAction refreshViewerAction =
        new Action(TefkatDataEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	...
	public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(TefkatDataEditorPlugin.INSTANCE.getString("_UI_DataEditor_menu"), "tefkat.dataMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(TefkatDataEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(TefkatDataEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(TefkatDataEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("additions", submenuManager);

        submenuManager = new MenuManager(TefkatDataEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
