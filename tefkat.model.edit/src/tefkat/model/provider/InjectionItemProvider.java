...
/**
 * This is the item provider adapter for a {@link tefkat.model.Injection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InjectionItemProvider
    extends TargetTermItemProvider
    implements	
     ...
     * @generated
     */
    public InjectionItemProvider(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        String label = ((Injection)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_Injection_type") :
            getString("_UI_Injection_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(Injection.class)) {
