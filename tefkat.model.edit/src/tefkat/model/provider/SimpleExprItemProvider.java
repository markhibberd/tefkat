...
/**
 * This is the item provider adapter for a {@link tefkat.model.SimpleExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleExprItemProvider
     ...
     * @generated
     */
    public SimpleExprItemProvider(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        String label = ((SimpleExpr)object).getRepresentation();
        return label == null || label.length() == 0 ?
            getString("_UI_SimpleExpr_type") :
            getString("_UI_SimpleExpr_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SimpleExpr.class)) {
